...
var metricsDefinition = map[string][]interface{}{
	...
	"db.hintsSucceededPerSecond": {"org.apache.cassandra.metrics:type=HintsService,name=HintsSucceeded", metric.GAUGE},
	"db.hintsFailedPerSecond":    {"org.apache.cassandra.metrics:type=HintsService,name=HintsFailed", metric.GAUGE},
	"db.hintsTimedOutPerSecond":  {"org.apache.cassandra.metrics:type=HintsService,name=HintsTimedOut", metric.GAUGE},
